...
///////////////////////////////////////////////////////////////////////////
    ...
    $address = "barrickoltman@sbcglobal.net";
...
//    $subject  = $_POST['subject'];
	...
	$error = '';
		...
		if(mail($address, $e_subject, $msg, "From: $email\r\nReturn-Path: $email\r\n")) {
		 ...
		 echo "<p>Thank you <strong>$name</strong>, your message has been submitted to us. We will get in touch with you as soon as possible.</p>";
		 echo "</div>";
		 echo "</fieldset>";
